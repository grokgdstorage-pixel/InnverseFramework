...
type: template
kit: Innverse
path: characters/templates/_person/history.md
status: stub
---
...
A human uses this as a refresher. A cold read uses it to write from their side, and to see which deeds might still sit in a Design packet. It is not a novel. It is not a reprint of `lore/campaign/archive.md` or `lore/campaign/chronicle.md`.
...
**What:** What happened. A paragraph or two is allowed on a load-bearing beat. Not the full archive. The Link holds the rest.
